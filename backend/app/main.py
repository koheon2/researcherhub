...
from app.models.paper import InstitutionNameMatch, Paper, PaperAuthor, PaperAuthorAffiliation, PaperFacet, PaperQualityFlag  # noqa: F401 - ensure tables are registered
